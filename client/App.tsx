          ...
          <Layout>
            <Routes>
              ...
              <Route
                ...
                element={<InviteContractor />}
              />
              <Route
                path="/projects/accept/:inviteToken"
              ...
              <Route
                ...
                element={
                  <PlaceholderPage
                    title="درباره ما"
                    description="اطلاعات درباره ضمانو"
                  />
                }
              />
              <Route
              ...
              <Route
                ...
                element={
                  <PlaceholderPage
                    title="سوالات متداول"
                    description="پاسخ سوالات پرتکرار"
                  />
                }
              />
              <Route
                ...
                element={
                  <PlaceholderPage
                    ...
                    description="شرایط و قوانین استفاده"
                  />
                }
              />
