      ...
      if (response.ok) {
        ...
        setFormData((prev) => ({
          ...
          message: prev.message.replace(
            /لینک زیر را کلیک کنید:.*$/m,
            `لینک زیر را کلی�� کنید:\n${link}`,
          ),
        }));
      } else {
        console.log(
          "❌ Invite link generation failed with status:",
          response.status,
        );
        ...
        <div className="container mx-auto max-w-2xl px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              مجری موردنظر خود را برای ای�� پروژه دعوت کنید
            </p>
          </div>
              ...
              {formData.method === "link" && inviteLink && (
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600">
                    این لینک را به مجری موردنظر ارسال کنید. او با کلیک روی آن
                    می‌تواند جزئیات پروژه را مشاهده کند.
                  </p>
                </div>
              )}
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>
                • پس از ارسال دعوت، پروژه در وضعیت "در انتظار پذیرش مجری" قرار
                می‌گیرد
              </li>
